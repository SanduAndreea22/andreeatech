...
PACKAGES = [
    ...
    },
    {
        ...
        "features": [
            "Tot ce include Digital Presence, plus:",
            ...
            "Dashboard unde vezi toate cererile într-un singur loc",
        ],
